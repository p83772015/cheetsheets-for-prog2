...
*** Solution
#+NAME: problem29.cpp
#+begin_src C++ :results output :cmdline <<< 29-floats.txt :exports both :tangle problem-29.cpp
  #include <iostream>
  #include <fstream>
  using namespace std;
...
*** Solution
#+begin_src C++ :results output :cmdline :exports both :tangle problem-30.cpp
  #include <iostream>
  #include <fstream>
  #include <algorithm>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-31.cpp
  #include <iostream>
  #include <fstream>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-32.cpp
  #include <iostream>
  #include <fstream>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-33.cpp
  #include <iostream>
  #include <fstream>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-34.cpp
  #include <iostream>
  #include <fstream>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-35.cpp
  #include <iostream>
  #include <fstream>
  #include <iomanip>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-36.cpp
  #include <iostream>
  #include <fstream>
  #include <sstream>
  using namespace std;
...
** Solution
#+begin_src C++ :tangle problem-37.cpp
  #include <iostream>
  #include <fstream>
  #include <sstream>
  using namespace std;
...
*** Solution
#+begin_src C++ :tangle problem-38.cpp
  #include <iostream>
  #include <fstream>
  #include <sstream>
  #include <iomanip>
...
*** Sample Output
#+begin_example
Welcome to Gross Pay Calulator Program!

Compute the gross pay of each employee from FILE.

Enter input FILE [1]: 38-employees.txt

            Name             SSN     Gross Pay
     ===========     ===========   ===========
    Eddie Vedder     555-98-4182        270.84
   Scott Weiland     555-53-2147         332.8
        Axl Rose     555-32-9826         261.6
    Phil Anselmo     555-09-4263           343
#+end_example

Original File:

#+CAPTION: 38-employees.txt
#+begin_example
Eddie Vedder|555-98-4182|7.32|37
Scott Weiland|555-53-2147|8.32|40
Axl Rose|555-32-9826|6.54|40
